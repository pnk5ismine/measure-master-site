...
const I18N = {
  ko: {
    ...
    "meta.description": "A4 용지와 같이 각 길이를 아는 기준 직사각형으로 투시 보정 후 길이/면적을 계산하는 Measure Master 앱",
    "nav.home": "홈",
    "nav.login": "로그인",
    "nav.reviews": "사용후기",
    "nav.privacy": "개인정보처리방침",
    "hero.title": "사진 속 왜곡을 보정해<br/>정확한 길이·면적을 계산",
    "hero.desc": "A4 용지와 같이 각 길이를 아는 기준 직사각형으로 투시 보정 후, 보정된 도형의 길이/면적을 산출합니다. 건축·실측·인테리어 현장에서 빠르고 간편하게.",
    ...
    "why.f1.desc": "A4 같은 기준 직사각형 4점만 지정하면 사진을 직사각형 기준으로 보정해 길이·면적을 신뢰성 있게 계산.",
  ...
  en: {
    ...
    "meta.description": "Measure Master calculates length and area by rectifying perspective using an rectangle knowing each lenfth like A4.",
    "nav.home": "Home",
    "nav.login": "Log In",
    "nav.reviews": "Reviews",
    "nav.privacy": "Privacy Policy",
    "hero.title": "Fix perspective in photos<br/>and measure length & area accurately",
    "hero.desc": "Use an refernce rectangle knowing each length like A4 paper to rectify perspective, then compute reliable length/area. Fast and handy for field work.",
    ...
    "why.f1.desc": "Specify 4 corners of an reference like A4 to rectify to a rectangle and obtain reliable length/area results.",
